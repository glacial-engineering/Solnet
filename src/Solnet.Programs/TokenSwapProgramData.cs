...
namespace Solnet.Programs
{
    ...
    internal static class TokenSwapProgramData
    {
        ...
        internal static byte[] EncodeInitializeData(byte nonce, Fees fees, SwapCurve swapCurve, byte poolNonce)
        {
            ...
            methodBuffer.WriteSpan(fees, 2);
            methodBuffer.WriteSpan(swapCurve.Pack(), 34);
            methodBuffer.WriteU8(poolNonce, 35);
